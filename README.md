...
<img width="540" height="1325" alt="abcdefghij" src="https://github.com/user-attachments/assets/27b1dc3d-10cd-4dce-9f78-dbcd7d9208c4" />



Project video explanation: [NicheTwin3D teaching video](https://youtu.be/jBrexNrnDWg)

Promotional Video: [NicheTwin3D Promotional Video (pending upgrade)](https://youtu.be/iKN4C6cgCPc)
...
If you want to retrain the base model and fine-tune the downstream classifier using your own spatial transcriptomics dataset (.h5ad format), please refer to the detailed tutorial below: custom_data_training.md
