...
class SpatialNicheDataset(Dataset):
    def __init__(self, h5ad_path, context_length=1024, n_neighbors=20):
        ...
        print(f"The dataset is ready. Number of cells: {self.adata.n_obs}")
...
def train():
    ...
    print(f"Configuration Trainer (Epochs: {MAX_EPOCHS}, Acc: {accelerator})...")
    ...
    print(f"Training completed, saving weights to {OUTPUT_PATH} ...")
